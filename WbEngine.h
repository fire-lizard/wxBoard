#ifndef HEADER_4365510721B33457
#define HEADER_4365510721B33457
...
public:
	...
	wxString AddMove(signed char x1, signed char y1, signed char x2, signed char y2, signed char x3, signed char y3);
	wxString AddMove(signed char x1, signed char y1, signed char x2, signed char y2, signed char x3, signed char y3, signed char x4, signed char y4);
